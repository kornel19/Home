...
Schema: https://drive.google.com/file/d/1oVMo8BT8igl_ri0lAACn2R434xA30Xxx/view?usp=sharing
...
x = int(input('Provide x coordinate: '))
y = int(input('Provide y coordinate: '))
